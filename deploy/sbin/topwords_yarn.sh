...
SPARK_HOME="/home/nlp/spark-xs.2.0.0"  #Spark home
topwords_jar="../release/topwords-1.0.jar"  #topwords jar file

# set the arguments
inputLoc="qfeng/topwords/newscorpus"  #location of input corpus in HDFS
inputFormat="text"  #format of input files (parquet/json/text)
outputLoc="qfeng/topwords/newscorpus_output" #location of output dictionary and segmented corpus in HDFS
...
num_executors="30"  #number of executors allocated
executor_cores="3"  #number of cores allocated for each executor
